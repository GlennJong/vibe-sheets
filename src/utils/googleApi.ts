// This file implements the logic that was previously in the Apps Script "master.js"
// It runs entirely on the client side, interacting directly with Google APIs.
